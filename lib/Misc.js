/**
   Return random entry in an array.
	 @method either
   @param {Array} arguments One or more items
	**/
...
/**
   Return if passage(s) appear in history.
	 @method hasVisited
   @param {Array} arguments One or more passage names
	**/
...
/**
	 ...
	 @method renderToSelector
   @param {string} selector HTML Query selector
   @param {Passage} passage The passage to render
	**/
...
/**
	 ...
	 @method getStyles
	 @param {string} arguments Array of URL addresses
	**/
